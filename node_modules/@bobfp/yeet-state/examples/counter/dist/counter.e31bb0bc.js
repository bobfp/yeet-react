...
},{"./cjs/react-dom.development.js":"../../node_modules/react-dom/cjs/react-dom.development.js"}],"../../src/yeet.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.YeetContext = exports.useGetter = exports.useSetter = exports.useYeet = exports.createStore = void 0;
...
var createStore = function createStore(initValue) {
  var value = initValue;
  var callBacks = {};
  Object.keys(initValue).forEach(function (atom) {
    return callBacks[atom] = {};
  });

  var getCurrent = function getCurrent(atom) {
    return function () {
      return value[atom];
    };
  };
  ...
  var subscribe = function subscribe(atom) {
    return function (cb) {
      var callBackID = Symbol();

      if (callBacks[atom]) {
        callBacks[atom][callBackID] = cb;
      } else {
        console.error("The atom ".concat(atom, " does not exist in the store"));
      }
  ...
  var publish = function publish(atom) {
    return function (setter) {
      var newValue = setter(value[atom]);

      if (value[atom] !== newValue) {
        value[atom] = newValue;
        Object.getOwnPropertySymbols(callBacks[atom]).forEach(function (cbID) {
          var cb = callBacks[atom][cbID];
          cb(newValue);
        });
      }
    };
...
var useYeet = function useYeet(atom, _ref) {
  var _ref2 = _slicedToArray(_ref, 2),
      getter = _ref2[0],
      setter = _ref2[1];

  var store = (0, _react.useContext)(YeetContext);

  var _useState = (0, _react.useState)(store.getCurrent(atom)),
      _useState2 = _slicedToArray(_useState, 2),
      state = _useState2[0],
      setState = _useState2[1];

  var yeetState = getter(state);

  var yeetSetState = function yeetSetState(val) {
    store.publish(atom)(setter);
  };

  (0, _react.useEffect)(function () {
    var unsubscribe = store.subscribe(atom)(setState);
    return function () {
      return unsubscribe();
    };
  }, []);
...
exports.useYeet = useYeet;

var useSetter = function useSetter(atom, setter) {
  var store = (0, _react.useContext)(YeetContext);
...
var useGetter = function useGetter(atom, getter) {
  var store = (0, _react.useContext)(YeetContext);

  var _useState3 = (0, _react.useState)(store.getCurrent(atom)),
...
var YeetContext = _react.default.createContext(null);

exports.YeetContext = YeetContext;
...
var counterLens = [function (state) {
...
var CounterDisplay = function CounterDisplay() {
  var counter = (0, _yeet.useGetter)("root", counterLens[0]);
  return _react.default.createElement("span", null, counter);
};

var Counter = function Counter() {
  var yeetCounter = (0, _yeet.useSetter)("root", function (val) {
    return function (state) {
      return _objectSpread({}, state, {
  ...
  var handleUpdateCounter = (0, _react.useCallback)(function (val) {
    return function () {
      yeetCounter(val);
    };
  }, []);
...
var CounterInput = function CounterInput() {
  var _useYeet = (0, _yeet.useYeet)("root", counterLens),
      _useYeet2 = _slicedToArray(_useYeet, 2),
      counter = _useYeet2[0],
      setCounter = _useYeet2[1];

  return _react.default.createElement("input", {
    type: "text",
    value: counter,
    onChange: function onChange(e) {
      return setCounter(Number(e.target.value));
    }
  });
};
...
var App = function App() {
  ...
  var store = (0, _yeet.createStore)(initValue);
  return _react.default.createElement(_yeet.YeetContext.Provider, {
    value: store
  }, _react.default.createElement(CounterDisplay, null), _react.default.createElement(Counter, null), _react.default.createElement(CounterInput, null));
};

_reactDom.default.render(_react.default.createElement(App, null), document.getElementById("root"));
},{"react":"../../node_modules/react/index.js","react-dom":"../../node_modules/react-dom/index.js","../../src/yeet":"../../src/yeet.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/counter.e31bb0bc.js.map